...
import {createContext, type PropsWithChildren, useCallback, useEffect, useState, useTransition,} from "react";
import {useShallow} from "zustand/react/shallow";
import type {DbSession, FullOrganization, Optional, Team, User,} from "~/domain";
import {authClient} from "~/lib/auth/client";
import {ORGANIZATION_SLUG, ROOT_ROUTE, SIGN_IN_ROUTE, SIGN_OUT_ROUTE,} from "~/lib/constants";
...
export function AuthContextProvider({children}: PropsWithChildren) {
    ...
    const {activeTeam, setActiveTeam, setIsAuthenticated} = useStore(useShallow((state) => state));

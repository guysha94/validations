...
type Props = {
    ruleField: FieldArrayWithId<SelectRule>;
    index: number;
    readOnly: boolean;
    form: UseFormReturn<{ rules: SelectRule[] }>;
    fields: FieldArrayWithId<SelectRule>[];
    toggleRuleEnabled: (index: number) => void;
    onRemove: (index: number) => void;
}

export default function RulesField({ruleField, index, form, readOnly, onRemove, fields, toggleRuleEnabled}: Props) {

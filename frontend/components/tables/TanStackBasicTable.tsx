    ...
    return (
        <div className="w-full">
            ...
            <div className="max-h-[60dvh] overflow-auto rounded-md border">
                {isLoading ? <Loader/> : <TanStackBasicTableTableComponent table={table}/>}
            </div>
            <div className="flex items-center justify-end space-x-2 py-4">
                ...
                <div>
                    <Select defaultValue={pagination.pageSize.toString()}
                            onValueChange={v => table.setPageSize(Number(v))}>
                        <SelectTrigger className="w-full max-w-48">
                            <SelectValue placeholder="Items per page" defaultValue={pagination.pageSize}/>
                        </SelectTrigger>
                        <SelectContent>
                            <SelectGroup>

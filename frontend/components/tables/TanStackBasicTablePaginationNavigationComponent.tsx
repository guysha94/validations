...
type TanStackBasicTablePaginationNavigationComponentProps<TData> = {
    table: Table<TData>;
}

export default function TanStackBasicTablePaginationNavigationComponent<TData>({table,}: TanStackBasicTablePaginationNavigationComponentProps<TData>) {
    return (
        <Pagination>
            <PaginationContent>

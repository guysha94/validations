    ...
    where TKey : notnull
{
    ...
    public async ValueTask<IEnumerable<TEntity>> GetAllAsync(CancellationToken ct = default)
    {
        try
        {
    ...
    public async ValueTask<TEntity?> GetByIdAsync(TKey id, CancellationToken ct = default)
    {
        try
        {
            await using var connection = await _connectionFactory.CreateOpenConnectionAsync(ct);
    ...
    public async ValueTask<TEntity?> CreateOneAsync(TEntityCreate entity, CancellationToken ct = default)
    {
        try
        {
    ...
    public async ValueTask<TEntity?> CreateOneAsync(TEntity entity, CancellationToken ct = default)
    {
        try
        {
    ...
    public async ValueTask<TEntity?> UpdateOneAsync(TKey id, TEntityUpdate entity, CancellationToken ct = default)
    {
    ...
    public async ValueTask<TEntity?> UpdateOneAsync(TKey id, TEntity entity, CancellationToken ct = default)
    {
        var setClause = string.Join(',', _columns.Where(p => p.Value.InUpdate)
            .Select(p => $"{p.Value.ColumnName} = @{p.Value.PropertyName}"));
    ...
    public async ValueTask<bool> DeleteOneAsync(TKey id, CancellationToken ct = default)
    {
        try
        {
            await using var connection = await _connectionFactory.CreateOpenConnectionAsync(ct);
    ...
    public async ValueTask<int> DeleteManyAsync(IEnumerable<TKey> ids, CancellationToken ct = default)
    {
        try
        {
            await using var connection = await _connectionFactory.CreateOpenConnectionAsync(ct);
    ...
    public async ValueTask<int> CreateManyAsync(IEnumerable<TEntityCreate> entities, CancellationToken ct = default)
    {
